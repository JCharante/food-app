        ...
        <View padding-15>
            <View marginT-10>
                ...
                {addonCatReq.data.map((addonCat) => {
                    return <CardItem key={addonCat.id}>
                        <View padding-15 flex>
                            <Text>{getName(addonCat.names, 'en')}</Text>
                        </View>
                        <View flex
                              right>
                            <Text onPress={() => navigation.push(`/merchant/restaurant/${restaurantID}/menu/addonCategory/${addonCat.id}`)}>Edit</Text>
                        </View>
                    </CardItem>
                })}
                <CardItem
                ...
                {addons.data.map((addon) => {
                    return <CardItem key={addon.id}>
                        <View padding-15 flex>
                            <Text>{getName(addon.names, 'en')}</Text>
                        </View>
                        <View flex
                              right>
                            <Text onPress={() => navigation.push(`/merchant/restaurant/${restaurantID}/menu/addons/${addon.id}`)}>Edit</Text>
                        </View>
                    </CardItem>
                })}
                <CardItem
